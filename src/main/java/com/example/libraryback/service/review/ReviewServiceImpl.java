...
public class ReviewServiceImpl implements ReviewService {
    ...
    @Override
    public ApiResult<ReviewsDTO> get(Integer size, Integer page, UUID bookId) {

        Page<Review> reviews = reviewRepository.findAllByBookId(bookId, PageRequest.of(page, size));

        Integer reviewsCount = reviewRepository.countByBookId(bookId);

        return ApiResult
                .successResponse(
                        mapReviewsDTO(reviews.getContent(), Long.valueOf(reviewsCount)));
    }
